...
def main():
    ...
    parser.add_argument('--best_model', type=str, default='./checkpoints/cnn-os-SMOTE-2.onnx', help='the relative path of saved best model')
    ...
    # # Load the ONNX model
    # model = onnx.load(config.best_model)
    #
